...
public class RechnerTest {
	...
	public void testBinaryOp() {
		...
		assertEquals(Rechner.berechne(Operation.DIVISION, 42, 0), Double.POSITIVE_INFINITY, 0.00001);
	}
	...
	public void testDoubleDoubleZuDouble() {
		...
		assertEquals(ddzd.werteAus(2, -84), 42, 0.00001);
		ddzd = (op1, op2) -> op1 / op2;
		assertEquals(ddzd.werteAus(42, 0), Double.POSITIVE_INFINITY, 0.00001);
	}
}
